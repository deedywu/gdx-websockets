...
The desktop, Android, RoboVM iOS, TeaVM Android, and TeaVM desktop-c launchers also expose `Local WSS permessage-deflate` for testing the same server through a self-signed local `wss://` connection.
